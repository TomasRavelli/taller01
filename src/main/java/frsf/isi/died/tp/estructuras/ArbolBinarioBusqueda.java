...
public class ArbolBinarioBusqueda extends Arbol {
	...
	public Integer tamanioLibros() {
		...
		if(this.valor.esLibro()) {
			return (1+this.derecho.tamanioLibros()+this.izquierdo.tamanioLibros());
		}else {
			return (this.derecho.tamanioLibros()+this.izquierdo.tamanioLibros());
		}
	}
	...
	public Integer tamanioVideos() {
		...
		if(this.valor.esVideo()) {
			return (1+this.derecho.tamanioVideos()+this.izquierdo.tamanioVideos());
		}else {
			return (this.derecho.tamanioVideos()+this.izquierdo.tamanioVideos());
		}
	}
	...
	public MaterialCapacitacion buscar(Integer precioBuscado) {
		...
		if(this.valor.precio().intValue()==precioBuscado) {
			...
			if(comparacion<0) {
				return derecho.buscar(precioBuscado);
			}else {
				return izquierdo.buscar(precioBuscado);
			}
		}
	}
